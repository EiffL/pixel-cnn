...
import data.galaxyzoo_data as galaxyzoo_data

# -----------------------------------------------------------------------------
parser = argparse.ArgumentParser()
# data I/O
parser.add_argument('-i', '--data_dir', type=str, default='/data2/GalaxyZoo', help='Location for the dataset')
parser.add_argument('-o', '--save_dir', type=str, default='/data2/GalaxyZoo/save', help='Location for parameter checkpoints and samples')
parser.add_argument('-d', '--data_set', type=str, default='galaxyzoo', help='Can be either cifar|imagenet|galaxyzoo')
...
# model
parser.add_argument('-q', '--nr_resnet', type=int, default=3, help='Number of residual blocks per stage of the model')
...
parser.add_argument('-a', '--init_batch_size', type=int, default=32, help='How much data to use for data-dependent initialization.')
...
if args.data_set == 'galaxyzoo' and args.class_conditional:
    raise("We currently don't have labels for the small imagenet data set")
DataLoader = {'cifar':cifar10_data.DataLoader, 'imagenet':imagenet_data.DataLoader, 'galaxyzoo':galaxyzoo_data.DataLoader}[args.data_set]
...
with tf.Session() as sess:
    for epoch in range(args.max_epochs):
        ...
        if epoch % args.save_interval == 0:
            ...
            fits.writeto(os.path.join(args.save_dir,'%s_sample%d.fits' % (args.data_set, epoch)), sample_x)
